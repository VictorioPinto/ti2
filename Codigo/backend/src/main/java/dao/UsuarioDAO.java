...
public class UsuarioDAO extends DAO {
    ...
    try {
        // Note que o 'id' NÃO está na lista de colunas, apenas os outros campos
    	String sql = "INSERT INTO usuarios (login, senha, nome, email, streak_days, nivel_atual_id) VALUES (?, ?, ?, ?, ?, ?);";
